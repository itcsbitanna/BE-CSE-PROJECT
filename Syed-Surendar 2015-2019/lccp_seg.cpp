...
int main(int argc, char ** argv)
{
	...
	ofstream outFile1("???3.txt", std::ios_base::out);
	...
	pcl::io::savePCDFileASCII("???3.pcd", *ColoredCloud1);
	...
	ofstream outFile2("?????3.txt", std::ios_base::out);
	...
	pcl::io::savePCDFileASCII("?????3.pcd", *ColoredCloud2);
	return 0;
}
